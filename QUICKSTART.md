...
| Top consumed tables / views (sqlglot AST + 30-day workload cache) | `sys.dm_pdw_exec_requests` + `INFORMATION_SCHEMA.TABLES` | [queries/workload_commands.sql](src/synapse_migration_analyzer/modules/dedicated_pools/queries/workload_commands.sql) + [workload_parser.py](src/synapse_migration_analyzer/modules/dedicated_pools/workload_parser.py) |
