...
from synapse_migration_analyzer.modules.security import rules as _rules
from synapse_migration_analyzer.modules.security.arm_client import _has_inline_secret
from synapse_migration_analyzer.modules.security.html_report import write_html
from synapse_migration_analyzer.modules.security.models import (
    CredentialEntry,
    FirewallRule,
    PoolTdeStatus,
    SecurityAnalysis,
