...
from synapse_migration_analyzer.modules.dedicated_pools.collectors.code_objects import (
...
def test_collect_code_objects_logs_per_type_counts(caplog: pytest.LogCaptureFixture) -> None:
    ...
    with caplog.at_level("INFO", logger="synapse_migration_analyzer.modules.dedicated_pools.collectors.code_objects"):
