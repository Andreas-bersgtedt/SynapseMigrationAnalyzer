...
from synapse_migration_analyzer.modules.pipelines import fabric_compat
from synapse_migration_analyzer.modules.pipelines.fabric_compat import analyze_activity
