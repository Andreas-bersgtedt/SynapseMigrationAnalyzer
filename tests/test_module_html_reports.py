...
from synapse_migration_analyzer.modules.fabric_mapping.html_report import write_html as fabric_html
from synapse_migration_analyzer.modules.fabric_mapping.models import (
    CapacityProjection,
    FabricMappingReport,
    ModuleSummary,
    ReadinessSummary,
...
from synapse_migration_analyzer.modules.monitoring.html_report import write_html as monitoring_html
from synapse_migration_analyzer.modules.monitoring.models import (
    DwuDayStat,
    LogAnalyticsResult,
    MetricSeries,
    MonitoringAnalysis,
)
from synapse_migration_analyzer.modules.pipelines.html_report import write_html as pipelines_html
from synapse_migration_analyzer.modules.pipelines.models import (
    Activity,
    Dataset,
    IntegrationRuntime,
    LinkedService,
...
from synapse_migration_analyzer.modules.spark_pools.html_report import write_html as spark_html
from synapse_migration_analyzer.modules.spark_pools.models import (
    Notebook,
    NotebookLintFinding,
...
from synapse_migration_analyzer.reporting.index_report import write_index
