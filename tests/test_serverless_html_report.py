...
from synapse_migration_analyzer.modules.serverless_pools.html_report import write_html
from synapse_migration_analyzer.modules.serverless_pools.models import (
    ExternalDataSource,
    ExternalTable,
    ExternalTableColumn,
    ServerlessAnalysis,
...
def test_serverless_html_drilldown(tmp_path: Path) -> None:
    ...
    # Header / metadata
    assert "Synapse Migration Analyzer" in text
