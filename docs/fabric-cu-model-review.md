...
### 2.1 Pipelines run-stats (`src/synapse_migration_analyzer/modules/pipelines/run_stats.py`)
...
### 2.2 Capacity (F-SKU) projection from monitoring (`src/synapse_migration_analyzer/modules/fabric_mapping/cu_projection.py`)
...
### 2.3 Estate aggregation (`src/synapse_migration_analyzer/web/estate.py`)
