...
> Synapse Migration Analyzer already produces, without introducing a
...
`src/synapse_migration_analyzer/modules/**/models.py`. It is intentionally
...
1. **Backend skeleton** (`src/synapse_migration_analyzer/web/`) — FastAPI
