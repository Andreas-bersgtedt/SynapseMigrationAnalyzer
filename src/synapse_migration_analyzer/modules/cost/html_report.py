...
<title>Synapse Migration Analyzer &mdash; Cost</title>
<style>{{ css }}</style></head><body>
<h1>Synapse Migration Analyzer &mdash; Cost</h1>
<div class="meta">
...
<table>
 <tr><th>Synapse avg/mo</th><td class="num">{{ '%.2f'|format(fc.synapse_avg_monthly_cost) }}</td></tr>
